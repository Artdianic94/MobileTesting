...
import com.MobileTesting.configuration.AddressConfigurator;
import com.MobileTesting.configuration.CapabilitiesConfigurator;
import com.MobileTesting.configuration.ConfigurationReader;
import com.MobileTesting.configuration.EnvironmentType;
...
public class DriverManager {
    ...
    public static void closeEmulator() {
        try {
            Runtime.getRuntime().exec(format("adb -s %s emu kill", ConfigurationReader.get().udid())); //Command to close the emulator
            LOG.info("AVD Emulator was closed");
        } catch (IOException e) {
